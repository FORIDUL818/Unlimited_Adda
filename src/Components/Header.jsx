    ...
    <div className="namvMain">
      <nav className="NavBer">
        <div className="Icons">
          ...
          <Link to='home/chating'><AiFillMessage /></Link>
        ...
        <div className="imageUploadModal">
          <div className="imageUploadContainer">
            ...
            <div className=" flex gap-6 mx-auto w-[450px]">
              <button onClick={getCropData} className="btn_v_1">
                Upload
              </button>
              <button onClick={HanlgeCloseModal} className="btn_v_2">
                Cansel
              </button>
            </div>
          </div>
